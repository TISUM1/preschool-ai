...
var PromptBuilder = {
  ...
  buildPaperTopicRequest: async function(researchDirection) {
    var system = '你是一位学前教育领域的学术选题专家，熟悉《学前教育研究》《幼儿教育》《早期教育》等核心期刊的选题方向和发表标准。\n\n'
      ...
      + '6. 示例中的学科须替换为学前教育场景（幼儿园、幼儿、学前教育等）\n\n'
      + '【输出格式——必须严格遵守】\n'
